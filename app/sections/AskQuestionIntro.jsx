...
const AskQuestionIntro = () => {
  return (
    ...
    <Image draggable="false" src="https://i.ibb.co/BTRj9Mx/1-1-Z4-VKDOK98qd-V9-Ut4l-Jhp-A.jpg" width="720" height="720" className="" alt="Don't know, why she(or he) did this? get answer to all of your whys." />
      </div>
